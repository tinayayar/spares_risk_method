-- quicksight_apm_score_fulljoin_qs.sql
-- QuickSight version of quicksight_apm_score_fulljoin.sql.
-- Identical logic; table references use the QuickSight / Athena catalog form
--   andes_bi_ext."ar-performance-n-insights".<table>
-- instead of "andes"."ar-performance-n-insights.<table>".
--
-- FULL OUTER JOIN of APM setup details and Layer 2 scores; keeps rows that
...
--   layer 2 score base: andes_bi_ext."ar-performance-n-insights".hw_critical_spares_score_base

...
-- Combined AR + MSP stockout score table
...
msp_parts AS (
  SELECT
    ...
    'MSP' AS source
  FROM "andes"."ar-performance-n-insights.hw_critical_spares_msp"
),

-- stockout_msp_qs_150d_raw_consumption.sql
...
-- Consumption source: ar-performance-n-insights.hw_raw_consumption_daily (curated dataset)
--
...
-- Replacements from curated daily consumption dataset
replacements AS (
  SELECT organization AS site,
         region,
         amazon_apn AS amzn_part,
         DATE(trl_date) AS replaced_on,
         CAST(qty_consumed AS FLOAT) AS qty_replaced
  FROM andes_bi_ext."ar-performance-n-insights"."hw_raw_consumption_daily"
